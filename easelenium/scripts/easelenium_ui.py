...
def main() -> None:
    """Run easelenium UI."""
    try:
        from wx import App  # noqa: PLC0415

        from easelenium.ui.main_ui import MainFrame  # noqa: PLC0415
    except ImportError:
        print("GUI dependencies are not installed. Run: pip install easelenium[gui]")  # noqa: T201
        sys.exit(1)

    app = App(redirect=False)
    main_ui = MainFrame(None)  # type: ignore[arg-type]
    main_ui.Show()
    app.MainLoop()
...
# TODO: if test case updated - doesn't updated in test runner # noqa: FIX002, TD002, TD003
...
# TODO: add enable/disable for uniq selector in 'Selector finder' # noqa: FIX002, TD002, TD003
# TODO: add support for adding code where mouse is located # noqa: FIX002, TD002, TD003
# TODO: when adding code auto wrap input if it is a string?? # noqa: FIX002, TD002, TD003
# TODO: move to Python3! # noqa: FIX002, TD002, TD003
# TODO: add copy selector in 'Selector finder' # noqa: FIX002, TD002, TD003
# TODO: if generation log window close - stop all generation # noqa: FIX002, TD002, TD003
# TODO: no vertical scroll in Windows in Editor tab # noqa: FIX002, TD002, TD003
# TODO: second import of page object is inserted incorrectly in Windows # noqa: FIX002, TD002, TD003
...
# TODO: split browser class into smaller classes like Waits, Getters etc # noqa: FIX002, TD002, TD003
# TODO: add support for headless drivers, mobile driver, remote execution # noqa: FIX002, TD002, TD003
# TODO: add save_page_code to browser and add auto save on failed # noqa: FIX002, TD002, TD003
# TODO: html option is not supported in Test runner in Windows # noqa: FIX002, TD002, TD003
