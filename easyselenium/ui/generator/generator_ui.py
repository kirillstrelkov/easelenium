...
from easyselenium.ui.utils import LINESEP, get_py_file_name_from_class_name, \
    FLAG_ALL_AND_EXPAND
from easyselenium.ui.widgets.utils import show_dialog, show_dialog_path_doesnt_exist, \
    show_dialog_bad_name, show_dialog_path_does_exist
...
class GeneratorTab(Panel):
    ...
    def __create_widgets(self):
        ...
        sizer.Add(self.select_image_panel, pos=(row, col), span=(1, 6), flag=FLAG_ALL_AND_EXPAND)
